...
const Technology = () => {
  ...
  const fetchTechnology = async () => {
    ...
    try {
      const response = await axios.get(
        "https://newsdata.io/api/1/latest?apikey=pub_e8140e97174a4115bc636c31a999c6bf&category=technology&language=ml"
      );
  ...
  return (
    <div className="container my-5">
      <h2 className="mb-4 text-primary">Technology News</h2>
