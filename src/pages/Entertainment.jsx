...
const Entertainment = () => {
  ...
  const fetchEntertainment = async () => {
    ...
    try {
      const response = await axios.get(
        "https://newsdata.io/api/1/latest?apikey=pub_e8140e97174a4115bc636c31a999c6bf&category=entertainment&language=ml"
      );
  ...
  return (
    <div className="container my-5 ">
      <h2 className="mb-4 text-primary mt-5">Entertainment News</h2>
