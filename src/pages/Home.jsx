...
'https://newsdata.io/api/1/latest?apikey=pub_e8140e97174a4115bc636c31a999c6bf&country=al,in,bd,au&language=ml&category=technology,politics,entertainment,lifestyle,education'      );
  ...
  return (
    <div className="d-flex flex-column min-vh-100">
      ...
      <section className="container my-5 flex-grow-1">
        <h2 className="mb-4 text-primary">Latest News</h2>
        {loading && (
